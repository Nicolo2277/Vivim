...
def parse_args():    
    ...
    parser.add_argument('-val_aug', type=bool, default=False, help='whether to apply data augmentation onto the validation dataset')
    parser.add_argument('-with_edge', type=bool, default=False, help='use edge_loss during Vivim training (requires pretraining)')
    parser.add_argument('-num_classes', type=int, default=2)
    parser.add_argument('-num_folds', type=int, default=1, help='number of folds used')
    parser.add_argument('-seed', type=int, default=42)
    parser.add_argument('-cv_group', type=str, help='Cross validation group')
    parser.add_argument('-max_numerosity', type=int, default=None, help='max num of clips selected by item')
