...
# Save the check script to a file
import argparse
import torch
from torch.utils.data import DataLoader
import matplotlib.pyplot as plt

# Import your dataset class (adjust the module path as needed)
...
def main(root, trainsize, clip_len, batch_size, num_workers):
    ...
    axes[0].axis("off")
    # masks (overlay background/solid/non-solid)
...
if __name__ == "__main__":
    ...
    parser.add_argument("--clip_len",   type=int, default=3,             help="Temporal clip length (odd)")
